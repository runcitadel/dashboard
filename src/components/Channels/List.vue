    ...
    <div class="channel-list">
      ...
      >
        <p class="text-muted w-75 text-center">
          🎉 We're opening payment channels to our first few users for free!
          Simply tweet a screenshot of your Umbrel's dashboard and tag us
          <a href="https://twitter.com/getumbrel" target="_blank">@getumbrel</a
          >.
        </p>
        <a
