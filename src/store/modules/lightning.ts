import type { Channel } from "@runcitadel/sdk/dist/middleware/autogenerated-types";
import type { Channel_extended } from "@runcitadel/sdk/dist/middleware/lnd/channel";
...
const lightningModule: Module<State, RootState> = {
  ...
  actions: {
    ...
    selectChannel({ commit, rootState }, channel) {
